...
![Previous Rank vs Current Rank](../outputs/eda/03_rank_rank-last-time_scatter.png){#fig-rank_scatter width=80%}
...
![](../outputs/results/05_actual-vs-predicted.png){#fig-actual_vs_predicted}
